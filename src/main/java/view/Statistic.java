...
import controller.DotScannerService;
...
public class Statistic {
    ...
    // ===== NHỊP & GIÁM SÁT =====
    private final long pollIntervalMs = 5000;   // quét mỗi 2s
    private final long heartbeatMs = 20_000; // in heartbeat mỗi 20s khi chờ
